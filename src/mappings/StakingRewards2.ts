...
import { StakingRewardsInfo2, StakingRewardsUser2, StakeTransaction2 } from '../types/schema'
...
const Staking_Rewards_Address = "0x0A0688fc15794035820CaDc23Db7114bAb4dE405"
...
export function handleStake(event: Staked): void {
  let stakeTransaction = StakeTransaction2.load(event.transaction.hash.toHexString())!
  stakeTransaction.type = "Stake"
  stakeTransaction.amountTransaction = event.params.amount
  stakeTransaction.save()

  let stakingRewardsInfo = StakingRewardsInfo2.load("StakingRewardsInfo2")!
  ...
  let stakingRewardsUser = StakingRewardsUser2.load(event.params.user.toHexString())!
...
export function handleStakeRewardPaid(event: RewardPaid): void {
  ...
  let stakingRewardsUser = StakingRewardsUser2.load(stakerUser)!
  ...
  let stakeTransaction = new StakeTransaction2(event.transaction.hash.toHexString())
...
export function handleRewardAdded(event: RewardAdded): void {
  ...
  if (stakingRewardsInfo === null) {
    stakingRewardsInfo = new StakingRewardsInfo2("StakingRewardsInfo2")
...
export function handleRewardStakeUpdated(event: RewardStakeUpdated): void {
  ...
  if (stakingRewardsUser === null) {
    stakingRewardsUser = new StakingRewardsUser2(stakerUser)
