...
import { StakingRewardsInfo5, StakingRewardsUser5, StakeTransaction5 } from '../types/schema'
...
const Staking_Rewards_Address = "0xa2c7FD9d6F9fCD50000DAaC552d931E0185D3Be6"
...
export function handleStake(event: Staked): void {
  let stakeTransaction = StakeTransaction5.load(event.transaction.hash.toHexString())!
  stakeTransaction.type = "Stake"
  stakeTransaction.amountTransaction = event.params.amount
  stakeTransaction.save()

  let stakingRewardsInfo = StakingRewardsInfo5.load("StakingRewardsInfo5")!
  ...
  let stakingRewardsUser = StakingRewardsUser5.load(event.params.user.toHexString())!
...
export function handleStakeRewardPaid(event: RewardPaid): void {
  ...
  let stakingRewardsUser = StakingRewardsUser5.load(stakerUser)!
  ...
  let stakeTransaction = new StakeTransaction5(event.transaction.hash.toHexString())
...
export function handleRewardAdded(event: RewardAdded): void {
  ...
  if (stakingRewardsInfo === null) {
    stakingRewardsInfo = new StakingRewardsInfo5("StakingRewardsInfo5")
...
export function handleRewardStakeUpdated(event: RewardStakeUpdated): void {
  ...
  if (stakingRewardsUser === null) {
    stakingRewardsUser = new StakingRewardsUser5(stakerUser)
